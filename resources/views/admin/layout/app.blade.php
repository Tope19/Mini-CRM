            ...
            <div class="left side-menu">
                ...
                <div class="left-side-logo d-block d-lg-none">
                    <div class="text-center">
                        <a href="{{ url('/home')}}" class="logo"><img src="{{asset('dashboard/assets/images/logo-dark.png') }}" height="20" alt="logo"></a>
                    </div>
                </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-calendar"></i> <span> Companies List </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('companies.index') }}">Add</a></li>
                                </ul>
                            </li>

                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-broadcast"></i> <span> Employees List </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('employees') }}">Add</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-left	d-none d-lg-block">
                            <div class="text-center">
                                ...
                                <a href="{{ url('/home')}}" class="logo"><img src="{{asset('dashboard/assets/images/logo.png') }}" height="20" alt="logo"></a>
                            </div>
                        </div>
